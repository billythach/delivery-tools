...
import com.lyra.delivery.repository.VersionRepository;
...
public class VersionResource {
    ...
    public ResponseEntity<Version> createVersion(@RequestBody Version version) throws URISyntaxException {
        ...
        if (version.getId() != null) {
            return ResponseEntity.badRequest().headers(HeaderUtil.createFailureAlert(ENTITY_NAME, "idexists", "A new version cannot already have an ID")).body(null);
        }
