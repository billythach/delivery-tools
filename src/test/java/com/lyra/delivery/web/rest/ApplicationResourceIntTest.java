...
import com.lyra.delivery.repository.ApplicationRepository;
...
public class ApplicationResourceIntTest {
    ...
    private static final String DEFAULT_ROADMAP_PATTERN = "AAAAAAAAAA";
    private static final String UPDATED_ROADMAP_PATTERN = "BBBBBBBBBB";

    private static final String DEFAULT_TICKET_DELIVERY = "AAAAAAAAAA";
    private static final String UPDATED_TICKET_DELIVERY = "BBBBBBBBBB";
    ...
    public static Application createEntity(EntityManager em) {
        Application application = new Application()
            .name(DEFAULT_NAME)
            .roadmapPattern(DEFAULT_ROADMAP_PATTERN)
            .ticketDelivery(DEFAULT_TICKET_DELIVERY);
        return application;
    }
    ...
    public void createApplication() throws Exception {
        ...
        assertThat(testApplication.getRoadmapPattern()).isEqualTo(DEFAULT_ROADMAP_PATTERN);
        assertThat(testApplication.getTicketDelivery()).isEqualTo(DEFAULT_TICKET_DELIVERY);
    }
    ...
    public void getAllApplications() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].roadmapPattern").value(hasItem(DEFAULT_ROADMAP_PATTERN.toString())))
            .andExpect(jsonPath("$.[*].ticketDelivery").value(hasItem(DEFAULT_TICKET_DELIVERY.toString())));
    }
    ...
    public void getApplication() throws Exception {
        ...
        restApplicationMockMvc.perform(get("/api/applications/{id}", application.getId()))
            ...
            .andExpect(jsonPath("$.roadmapPattern").value(DEFAULT_ROADMAP_PATTERN.toString()))
            .andExpect(jsonPath("$.ticketDelivery").value(DEFAULT_TICKET_DELIVERY.toString()));
    }
    ...
    public void updateApplication() throws Exception {
        ...
        updatedApplication
            .name(UPDATED_NAME)
            .roadmapPattern(UPDATED_ROADMAP_PATTERN)
            .ticketDelivery(UPDATED_TICKET_DELIVERY);
        ...
        assertThat(testApplication.getRoadmapPattern()).isEqualTo(UPDATED_ROADMAP_PATTERN);
        assertThat(testApplication.getTicketDelivery()).isEqualTo(UPDATED_TICKET_DELIVERY);
    }
